...
import type { TinyPedidoCompleto, TinyEndereco } from '@/lib/olist/types'
import { isOrderFromLI, parseLIData } from '@/app/admin/lib/parseObs'
...
export default function PrintPage() {
  ...
  const [order, setOrder] = useState<TinyPedidoCompleto | null>(null)
  ...
  useEffect(() => {
    ...
    const clienteEndereco: TinyEndereco | undefined =
