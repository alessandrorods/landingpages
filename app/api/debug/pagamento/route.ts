...
import { createPagamentoService } from '@/lib/mercadopago/pagamento.service'
...
export async function POST() {
  ...
  const token = signToken({ pedidoId: 0, pedido: 'DEBUG-001', sku: 'AR06', nome: 'Alessandro', valor: 184.90 })
