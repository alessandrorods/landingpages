...
import { trackAddToCart } from '@/core/analytics'
  ...
  const cls =
    variant === 'large'
      ...
      : variant === 'icon'
        ...
        : 'block w-full bg-[#1E7439] hover:bg-[#155C2C] active:scale-95 text-white font-bold px-4 py-3 rounded-xl transition-all text-xs sm:text-sm text-center cursor-pointer'
